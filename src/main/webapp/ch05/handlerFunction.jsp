...
<body>
	...
	<input type="radio" name="grade" value="####x"> ####x <br>
	<input type="radio" name="grade" value="###xx"> ###xx <br>
	<input type="radio" name="grade" value="##xxx"> ##xxx <br>
	<input type="radio" name="grade" value="#xxxx"> #xxxx <br>
	<hr>&nbsp;&nbsp;
